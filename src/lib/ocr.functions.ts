...
export const generateSolvedPhoto = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    ...
    const texto =
      ...
      handwritingProfile +
      ". Use essa descrição junto com a referência visual. Gere novamente a PRIMEIRA página, idêntica no papel, texto impresso, iluminação, perspectiva e enquadramento, acrescentando somente as respostas manuscritas. Escreva a LÁPIS grafite com traço FRACO, CLARO, ACINZENTADO, pressão instável e falhas naturais. A escrita deve ser CURSIVA, porém EXTREMAMENTE FEIA, GARRANCHADA, TORTA E QUEBRADA — nada de letra redonda, bonita ou caligráfica. INSTRUÇÕES VISUAIS OBRIGATÓRIAS: letras ligadas de forma forçada e desajeitada, com laços TORTOS, PONTUDOS e IRREGULARES; hastes que saem tortas, entram e saem de outros traços no lugar errado, ligações quebradas ou exageradas. Evite curvas suaves, arcos perfeitos ou arredondamento. Letras pareçam DESMONTADAS/QUEBRADAS: partes soltas, traços desconectados, pontas tortas, laços que não fecham direito. Linha de base MUITO ondulada, subindo e descendo visivelmente; letras desalinhadas, algumas gigantes, outras miúdas, dentro da mesma palavra. Inclinação variando a cada letra. Espaçamento caótico: letras quase coladas, depois buracos grandes. Tremores, retraços, traços extras, rabiscos leves, marcas de correção/apagado e manchas de grafite. Acentos e pontos tortos, traços do 't' e 'f' tortos, círculos de 'a', 'o', 'd' achatados ou quadrados. Números desengonçados, com curvas fechadas demais ou abertas demais. Quanto mais garranchado, feio, quebrado, desleixado e cursivamente desastroso, melhor. NÃO mude a grafia nem a ortografia das palavras: as letras devem permanecer reconhecíveis como as mesmas palavras da resposta, apenas visualmente desastrosas. As pequenas marcas X também devem parecer feitas a lápis, fracas e imperfeitas. Não copie o conteúdo da segunda imagem; copie exclusivamente a caligrafia. Não adicione marcas d'água nem texto extra." +
      regras +
      listaRespostas;
