...
export const generateSolvedPhoto = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    ...
    const texto =
      ...
      handwritingProfile +
      ". Use essa descrição junto com a referência visual. Gere novamente a PRIMEIRA página, idêntica no papel, texto impresso, iluminação, perspectiva e enquadramento, acrescentando somente as respostas manuscritas. Escreva a LÁPIS grafite com traço fraco, claro e acinzentado, pressão instável e falhas naturais. A escrita deve parecer FEIA, GARRANCHADA e TORTA — o oposto de letra redonda ou bonita. Evite arredondamento: as letras devem ter cantos, ângulos, pontas e hastes quebradas. Linha de base ondulada e irregular; letras claramente desalinhadas, tamanhos variados, inclinação variando dentro da mesma palavra, espaçamento inconsistente. Hastes tortas, curvas fechadas ou abertas demais, letras que parecem quase coladas e outras afastadas, tremores e falhas de pressão. Inclua traços extras, retraços, rabiscos leves, marcas de correção/apagado e pequenas manchas de grafite ao redor de algumas letras. Quanto mais feia, torta e garranchada, melhor. NÃO mude a grafia nem a ortografia das palavras: as letras devem permanecer reconhecíveis como as mesmas palavras da resposta, apenas visualmente desengonçadas. As pequenas marcas X também devem parecer feitas a lápis, fracas e imperfeitas. Não copie o conteúdo da segunda imagem; copie exclusivamente a caligrafia. Não adicione marcas d'água nem texto extra." +
      regras +
      listaRespostas;
